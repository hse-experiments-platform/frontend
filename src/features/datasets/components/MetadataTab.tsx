...
import { DatasetMetadata, isDatasetLoaded, isLoadError } from '../../../model/datasets';
...
export const MetadataTab = ({metadata}: MetadataTabProps) => {    
    ...
    return (
        <div>
            ...
            {
                metadata && isLoadError(metadata.status) && <LoadingErrorVisualizer id={metadata.id} error={metadata.uploadError}/>
            }
        </div>
    )
}